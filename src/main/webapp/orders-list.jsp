...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<li><a
					href="${pageContext.request.contextPath}/orders/findAll.do?page=1&&size=3">订单管理</a></li>
								...
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建"
											onclick="location.href='${pageContext.request.contextPath}/orders-add.jsp'">
											<i class="fa fa-file-o"></i> 新建
										</button>
										<button type="button" class="btn btn-default" title="删除" onclick="f1()">
										...
										onclick="location.href='${pageContext.request.contextPath}/orders/findAll.do?page=1&&size=3'">
                        ...
                        <ul class="pagination">
                            ...
                            <li><a href="${pageContext.request.contextPath}/orders/findAll.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a></li>
                           	...
                           	<c:forEach begin="1" end="${pageInfo.pages}" var="p">
                           		<li><a href="${pageContext.request.contextPath}/orders/findAll.do?page=${p}&size=${pageInfo.pageSize}">${p}</a></li>
                           	</c:forEach>
	...
	<script>
		function f1(){ //jquery获取复选框值 
		    ...
		    location.href = "${pageContext.request.contextPath}/orders/delete.do?ids="+chk_value;
		} 
