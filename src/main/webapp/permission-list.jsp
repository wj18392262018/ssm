	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					资源权限查询 <small>资源权限查询列表</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="${pageContext.request.contextPath}/main.jsp"><i class="fa fa-dashboard"></i> 首页</a></li>
					<li><a href="${pageContext.request.contextPath}/permission/findAll.do?page=1&&size=3">资源权限查询管理</a></li>
					<li class="active">资源权限查询列表</li>
				</ol>
			</section>
			<!-- 内容头部 /-->
								...
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建"
											onclick="location.href='${pageContext.request.contextPath}/permission-add.jsp'">
										...
										<button type="button" class="btn btn-default" title="刷新"
											onclick="location.href='${pageContext.request.contextPath}/permission/findAll.do?page=1&&size=3'">
									...
									<c:forEach items="${pageInfo.list}" var="permission">
										...
										<tr>
											...
											<td class="text-center">
												...
												onclick="location.href='${pageContext.request.contextPath}/permission/findById.do?id=${user.id}'">
												详情</button>
							...
							<ul class="pagination"> <li>
	                            ...
	                            <li><a href="${pageContext.request.contextPath}/permission/findAll.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a></li>
	                           	...
	                           	<c:forEach begin="1" end="${pageInfo.pages}" var="p">
	                           		<li><a href="${pageContext.request.contextPath}/permission/findAll.do?page=${p}&size=${pageInfo.pageSize}">${p}</a></li>
	                           	</c:forEach>
