							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<%--onclick="location.href='${pageContext.request.contextPath}/product/delete.do'"> --%>
										...
										<button type="button" class="btn btn-default" title="刷新"
											onclick="location.href='${pageContext.request.contextPath}/product/findAll.do?page=1&&size=3'">
							...
							<ul class="pagination"> <li>
	                            ...
	                            <li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a></li>
	                           	...
	                           	<c:forEach begin="1" end="${pageInfo.pages}" var="p">
	                           		<li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${p}&size=${pageInfo.pageSize}">${p}</a></li>
	                           	</c:forEach>
	...
	<script>
		...
		$(document).ready(function() {
			...
			$(".btn btn-default").click(function (){
				...
				$.post('${pageContext.request.contextPath}/product/delete.do', {ids:data.toString()}, function(json) {
