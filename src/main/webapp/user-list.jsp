		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li><a href="${pageContext.request.contextPath}/user/findAll.do?page=1&&size=3">用户管理</a></li>
								...
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建"
											onclick="location.href='${pageContext.request.contextPath}/user-add.jsp'">
										...
										<button type="button" class="btn btn-default" title="刷新"
											onclick="location.href='${pageContext.request.contextPath}/user/findAll.do?page=1&&size=3'">
									...
									<c:forEach items="${pageInfo.list}" var="user">
										...
										<tr>
											...
											<td class="text-center">
												...
												<button type="button" class="btn bg-olive btn-xs"
												onclick="location.href='${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?userid=${user.id}'">
												添加角色</button>
											</td>
										</tr>
									</c:forEach>
							...
							<ul class="pagination"> <li>
	                            ...
	                            <li><a href="${pageContext.request.contextPath}/user/findAll.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a></li>
	                           	...
	                           	<c:forEach begin="1" end="${pageInfo.pages}" var="p">
	                           		<li><a href="${pageContext.request.contextPath}/user/findAll.do?page=${p}&size=${pageInfo.pageSize}">${p}</a></li>
	                           	</c:forEach>
