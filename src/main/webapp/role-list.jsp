	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li><a
					href="${pageContext.request.contextPath}/role/findAll.do?page=1&&size=3">角色管理</a></li>
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="刷新" onclick="location.href='${pageContext.request.contextPath}/role/findAll.do?page=1&&size=3">
									...
									<c:forEach items="${pageInfo.list}" var="role">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/role/findRoleByIdAndAllPermission.do?roleid=${role.id}" class="btn bg-olive btn-xs">添加角色权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
							...
							<ul class="pagination"> <li>
	                            ...
	                            <li><a href="${pageContext.request.contextPath}/role/findAll.do?page=${pageInfo.pageNum-1}&size=${pageInfo.pageSize}">上一页</a></li>
	                           	...
	                           	<c:forEach begin="1" end="${pageInfo.pages}" var="p">
	                           		<li><a href="${pageContext.request.contextPath}/role/findAll.do?page=${p}&size=${pageInfo.pageSize}">${p}</a></li>
	                           	</c:forEach>
